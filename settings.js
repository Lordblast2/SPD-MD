...
// @telegram : t.me/chrisgaaju20
// @github : lordblast2 
// @whatsapp : +2348038915922
...
//Enter your Striker session id here; must start with striker:~
...
global.ownernumber = process.env.OWNER_NUMBER || '2348038915922' 

//--------------------[ SUDO ]--------------------------//

global.sudo = process.env.SUDO ? process.env.SUDO.split(',') : ['2348038915922', '2348069675806'];
...
global.packname = process.env.STICKER_PACK_NAME || "Striker" 

//--------------[ STICKER AUTHOR NAME ]------------//

global.author = process.env.STICKER_AUTHOR_NAME || "lee" 
...
global.plink = process.env.PLINK || "https://www.instagram.com/"

//------------------[ WATERMARK ]--------------------//

global.wm = process.env.GL_WM || "> ©Striker xmd"
